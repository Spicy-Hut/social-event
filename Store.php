...
<body>
   <header>
        ...
        <div class="container d-flex juestify-content-evenly ">
         <div>
           <p class="m-5">OFFICAL EVENT TSHIRT</p>
           <P class="m-5">RS 499</P>
         </div>
         <div>
           <p class="m-5">CAMPUS TO PRO-BOOK</p>
           <P class="m-5">RS 499</P>
         </div>
         <div>
           <p class="m-5">EVENT MARCH</p>
           <P class="m-5">RS 499</P>
         </div>
        </div>
